...
JSNES.CPU = function(nes) {
    ...
    // 寄存器
    this.REG_ACC = null;  // 累加寄存器
    this.REG_X = null;  // X 索引寄存器
    this.REG_Y = null;  // Y 索引寄存器
    this.REG_SP = null;  //  栈指针
    this.REG_PC = null;  // 指令计数器
    this.REG_PC_NEW = null;
    this.REG_STATUS = null;  // 状态寄存器

    this.F_CARRY = null;  // 进位标记
    this.F_DECIMAL = null;  // 十进制模式
    this.F_INTERRUPT = null;  // 禁止中断
    this.F_INTERRUPT_NEW = null;
    this.F_OVERFLOW = null; // 溢出
    this.F_SIGN = null;  // 符号标记
    this.F_ZERO = null; // 零标记
    this.F_NOTUSED = null; //  保留标记
    this.F_NOTUSED_NEW = null;
    this.F_BRK = null; // 软件中断
    this.F_BRK_NEW = null;
...
JSNES.CPU.prototype = {
    ...
    setStatus: function(st){  // 00101000
        this.F_CARRY     = (st   )&1;
        this.F_ZERO      = (st>>1)&1;
