...
class ROM {
    ...
    constructor(nes) {
        ...
        this.mapperName[140] = "Mapper 140";
        this.mapperName[180] = "Mapper 180";
    }
    ...
    load(data) {
        ...
        this.mirroring = ((this.header[6] & 1) !== 0 ? 1 : 0);   //  镜像标志位   0 - 水平， 1 - 竖直
        this.batteryRam = (this.header[6] & 2) !== 0;   //  是否拥有电池的 SRAM
        this.trainer = (this.header[6] & 4) !== 0;
        this.fourScreen = (this.header[6] & 8) !== 0;  //  是否是四屏显示
